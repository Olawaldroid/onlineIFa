...
// Section 05 — clickable concept map. Edges are drawn on a canvas; nodes are
// absolutely-positioned buttons. Selecting a node zooms the stage toward it.
export function KnowledgeGraph() {
  ...
  return (
    <section id="graph" className="bg-ifa-paper px-10 pb-[120px] pt-[110px] text-ifa-ink">
      <div className="mx-auto max-w-[1120px]">
        <SectionHeading num="05" title="Knowledge Graph" light />
        ...
        <div className="relative mt-5 h-[560px] overflow-hidden rounded-[18px] border border-ifa-border bg-ifa-surface">
          <div
            ...
            style={{ transform, transitionTimingFunction: "cubic-bezier(.3,.7,.2,1)" }}
          >
            ...
            {GRAPH_NODES.map((n) => {
              ...
              const linked =
                sel !== null &&
                GRAPH_EDGES.some(([a, b]) => (a === sel && b === n.id) || (b === sel && a === n.id));
          ...
          {selNode ? (
            <div
              className="absolute bottom-5 left-5 max-w-[380px] rounded-[14px] border border-ifa-gold/50 bg-ifa-bg/[0.92] px-5 py-[18px] backdrop-blur-lg"
              style={{ animation: "omFadeUp .35s ease both" }}
            >
              <div className="text-[10.5px] tracking-[0.22em] text-ifa-gold">
                {GRAPH_CAT_NAMES[selNode.cat]}
              </div>
