...
export const metadata = {
  title: "History — Online Ifá",
};

export default function HistoryPage() {
  return (
    <section className="bg-ifa-bg pb-[120px] pt-20 sm:pt-[110px]">
      <div className="mx-auto max-w-[1120px] px-6 sm:px-10">
        <SectionHeading num="01" title="A history in six movements" />
        <p className="mb-0 mt-4 text-[15px] text-ifa-cream/65">
          Scroll sideways through the arc of the tradition →
        </p>
      </div>
      <div className="flex snap-x snap-mandatory gap-5 overflow-x-auto px-6 pb-5 pt-11 sm:px-10">
        {ERAS.map((e) => (
          <div key={e.when} className="w-[340px] flex-none snap-start rounded-[18px] border border-ifa-border bg-ifa-surface p-[30px] transition-colors duration-300 hover:border-ifa-gold">
