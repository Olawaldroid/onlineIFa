...
export const MUSEUM_ITEMS: MuseumItem[] = [
  {
    ...
    credit: "Brooklyn Museum, 75.147.1 — CC BY 3.0, via Wikimedia Commons",
  ...
  },
  {
    ...
    credit: "Dornicke / Museu Nacional, UFRJ — CC BY-SA 4.0, via Wikimedia Commons",
  ...
  },
  {
    ...
    credit: "Jogo de Ikin Orossi — public domain, via Wikimedia Commons",
  ...
  },
  {
    ...
    credit: "Brooklyn Museum, 75.150.1 — CC BY 3.0, via Wikimedia Commons",
