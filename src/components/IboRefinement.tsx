  ...
  return (
    <div className="card">
      ...
      <p className="mb-3 text-[13px] leading-relaxed text-ifa-cream/70">
        ...
        instruments for casting lots. A pair of cowries answers <em>yes</em> (ire, blessing); a piece of
        bone answers <em>no</em> (ibi, obstacle). The diviner does not know which hand holds which.
      </p>
        ...
        <div>
          ...
          >
            ...
            <p className="mx-auto mt-2 max-w-md text-[13.5px] leading-relaxed text-ifa-cream/80">
              {isIre
                ? "The reading leans toward blessing. Tradition would next refine which ire — health, prosperity, longevity — through further alternatives."
                : "The reading leans toward obstacle — read as counsel, not doom. Tradition would next refine what to guard against and what action restores balance."}
            </p>
          </div>
